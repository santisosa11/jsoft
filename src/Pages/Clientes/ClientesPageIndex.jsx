...
export function ClientesPageIndex(props) {
    ...
    const {
      ...
      const actions = [
        {
          icon: () => <Link to="/Clientes/ClientesPageNew"><AddIcon color="action"/></Link>,
          tooltip: 'Nuevo',
          isFreeAction: true,
        },
        {
          icon: () => <Link to="/Clientes/ClientesPageEdit"><EditIcon color="action"/></Link>,
          tooltip: 'Editar',
          onClick: (event, rowData) => {
            const memoria = rowData
            localStorage.setItem('cliente', JSON.stringify(memoria))
          }
